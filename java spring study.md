...
# eclipse配置
* 下载相应的jar包
  - spring-framework-3.1.1.RELEASE-with-docs.zip/dist/下的所有jar包
...
[此文参照了开涛写的spring web mvc](http://sishuok.com/forum/blogPost/list/5160.html)
